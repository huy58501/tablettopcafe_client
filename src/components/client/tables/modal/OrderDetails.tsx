...
const OrderDetails: React.FC<OrderDetailsProps> = ({ order, onClose, onSplitBill }) => {
  ...
  const handlePaymentComplete = () => {
    ...
    // Close the OrderDetails modal after payment is completed
    onClose();
    // Here you would typically update the order status or handle the payment completion
    // For example, you might want to update the order status or close the order
  };
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3.5 px-4 bg-green-600 text-white font-medium 
                         rounded-xl hover:bg-green-700 transition-colors flex items-center justify-center gap-2"
              >
                <FaMoneyBill />
                Pay Bill
              </button>
